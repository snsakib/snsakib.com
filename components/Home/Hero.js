...
export default function HomeHero() {
  return (
    <section id="home-hero">
      <div className="w-full text-center" id="hero-title">
        <h1
          className={
        ...
        <div
          id="contact-links"
          className="flex justify-around w-full md:w-6/12 lg:w-4/12"
        >
          {/* Email Link */}
          <a
      ...
      <div className="my-10 overflow-hidden rounded-xl" id="hero-video">
        <video
          controls
          poster="/assets/img/home-hero-video-poster.jpg"
          className="border"
        >
